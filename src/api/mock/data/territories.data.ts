...
export const territoryProviders = {
  ...
  paris: {
    ...
    dispatch: [
      { name: "CoordiFleet", state: "on" }
    ],
    security: [
      { name: "SafeWatch Paris", state: "on" }
    ]
  },
  ...
  lyon: {
    shuttles: [
      { name: "Rhône Shuttle", state: "on" }
    ],
    dispatch: [
      { name: "LyoDispatch", state: "errors" } // déclenche errors
    ],
    security: [
      { name: "LyonSecure", state: "on" }
    ]
  },
  ...
  marseille: {
    shuttles: [
      { name: "Blue Coast Shuttle", state: "unknown" }
    ],
    dispatch: [
      { name: "PortoDispatch", state: "off" } // déclenche unstable
    ],
    security: [
      { name: "MarSec", state: "on" }
    ]
  },
  ...
  lille: {
    shuttles: [
      { name: "NordNavette", state: "off" }
    ],
    dispatch: [],
    security: [
      { name: "LilleGuard", state: "off" }
    ]
  },
  ...
  toulouse: {
    ...
    dispatch: [
      { name: "ToulDispatch", state: "on" }
    ],
    security: [
      { name: "RedBrick Security", state: "on" }
    ]
  },
  ...
  nice: {
    shuttles: [
      { name: "AzurNavette", state: "on" }
    ],
    dispatch: [
      { name: "NiceDispatch", state: "unknown" }
    ],
    security: [
      { name: "CôteSafe", state: "on" }
    ]
  },
  ...
  bruxelles: {
    shuttles: [
      { name: "BruxMove", state: "on" }
    ],
    dispatch: [
      { name: "DispatchBe", state: "on" }
    ],
    security: [
      { name: "BelgSecure", state: "on" }
    ]
  },
  ...
  amsterdam: {
    shuttles: [
      { name: "CanalShuttle", state: "on" }
    ],
    dispatch: [
      { name: "AmstelDispatch", state: "on" }
    ],
    security: [
      { name: "DutchGuard", state: "on" }
    ]
  },
  ...
  berlin: {
    shuttles: [
      { name: "MetroShuttle DE", state: "errors" }
    ],
    dispatch: [
      { name: "BerlinDispatch", state: "on" }
    ],
    security: [
      { name: "BrandenSecure", state: "on" }
    ]
  },
  ...
  madrid: {
    shuttles: [
      { name: "Madrid Shuttle", state: "off" }
    ],
    dispatch: [
      { name: "CastillaDispatch", state: "off" }
    ],
    security: [
      { name: "IberiaSecure", state: "off" }
    ]
  }
};
